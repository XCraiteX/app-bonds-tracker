...
> Внимание! ~20% Frontend части было написано ИИ, т.к. я не смог понять как сделать грамотно календарь. Основной проект фронта был написан очень давно и вообще на Python FastAPI. Я решил переписать проект на GO, изменить дизайн, доработать мелочи, т.к. хотел сделать полноценное приложение, а так-же перейти на golang. Frontend часть плохого качества написания кода. В качестве архитектуры выбран FSD.
